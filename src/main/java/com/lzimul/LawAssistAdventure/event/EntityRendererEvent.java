...
import com.lzimul.LawAssistAdventure.client.hud.MainMenu;
...
//        }
    ...
    public static void registerGuiOverlays(RegisterGuiOverlaysEvent registerGuiOverlaysEvent) {
        registerGuiOverlaysEvent.registerAboveAll(new ResourceLocation(MODID,"menu"), MainMenu.getInstance());
    }
