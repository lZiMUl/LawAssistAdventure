...
public class TeleporterScreen extends AbstractContainerScreen<TeleporterMenu> {
    ...
    protected void init() {
        ...
        WidgetSprites widgetSprites = new WidgetSprites(getResourceLocation(Config.Mode.ITEM, "teleporter"), getResourceLocation(Config.Mode.ITEM, "teleporter"));
    ...
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float p_97788_, int p_97789_, int p_97790_) {
        ...
        guiGraphics.blit(getResourceLocation(Config.Mode.ITEM, "teleporter"), 0, 0, 0, 0, imageWidth - 149, imageHeight - 170, imageWidth, imageHeight);
    }
