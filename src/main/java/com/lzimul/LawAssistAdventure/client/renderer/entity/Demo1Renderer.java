...
public class Demo1Renderer extends EntityRenderer<Demo1Entity> {
    private final EntityModel<Demo1Entity> DemoModel;
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull Demo1Entity demo) {
        return new ResourceLocation(MODID, "textures/entity/demo1.png");
    }

    @Override
    public void render(@NotNull Demo1Entity entity, float entityYaw, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource multiBufferSource, int packedLight) {
