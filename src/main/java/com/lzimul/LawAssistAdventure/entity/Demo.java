...
public class Demo extends Entity {
    private static final EntityDataAccessor<Integer> COUNTER = SynchedEntityData.defineId(Demo.class, EntityDataSerializers.INT);

    public Demo(EntityType<?> entityType, Level level) {
