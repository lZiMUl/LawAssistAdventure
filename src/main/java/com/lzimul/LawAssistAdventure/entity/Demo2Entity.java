...
public class Demo2Entity extends Entity {
    private static final EntityDataAccessor<Integer> COUNTER = SynchedEntityData.defineId(Demo2Entity.class, EntityDataSerializers.INT);

    public Demo2Entity(EntityType<?> entityType, Level level) {
